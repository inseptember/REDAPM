...
def main():
    ...
    # drug_code_features = list(range(461))
    ...
    drug_code_features = 0
    with open(args.drug_indx_file, 'r', encoding='utf8') as f:
        drug_code_features = len(json.load(f))
    ...
    model = BertForSequenceClassification.from_pretrained(
        ...
        num_other=len(all_features) + drug_code_features
    )
